...
extern  int * elimina_occorrenze_1(Name *, CLIENT *);
extern  int * elimina_occorrenze_1_svc(Name *, struct svc_req *);
#define LISTA_SOTTODIRETTORIO 2
extern  Output * lista_sottodirettorio_1(Name *, CLIENT *);
extern  Output * lista_sottodirettorio_1_svc(Name *, struct svc_req *);
...
#define LISTA_SOTTODIRETTORIO 2
extern  Output * lista_sottodirettorio_1();
extern  Output * lista_sottodirettorio_1_svc();
