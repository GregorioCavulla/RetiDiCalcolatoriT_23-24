...
{
	union {
		Name elimina_occorrenze_numeriche_1_arg;
		Name lista_file_direttorio_1_arg;
	} argument;
	char *result;
	...
	case ELIMINA_OCCORRENZE_NUMERICHE:
		_xdr_argument = (xdrproc_t) xdr_Name;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) elimina_occorrenze_numeriche_1_svc;
		break;

	case LISTA_FILE_DIRETTORIO:
		_xdr_argument = (xdrproc_t) xdr_Name;
		_xdr_result = (xdrproc_t) xdr_Output;
		local = (char *(*)(char *, struct svc_req *)) lista_file_direttorio_1_svc;
		break;
