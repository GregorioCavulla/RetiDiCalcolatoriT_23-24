...
int main(int argc, char *argv[]) // client
{
    ...
    int *ris;                  // risultato
    char c;                    // carattere di fine linea
    Output *classificaGiudici; // classifica dei giudici, struttura in file: xfactor.x
    char ok[2], nl[2];         // stringa di controllo e carattere di fine linea
    Input input;               // input per la votazione
