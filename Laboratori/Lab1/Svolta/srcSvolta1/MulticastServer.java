...
public class MulticastServer {
	 ...
	 * delle cartelle src e bin. In questo modo posso referenziarlo senza usare
	 * l'intero path.
	 */
		...
		try {
			if (args.length == 1) {
				...
				try {
					...
					System.out
							.println(
									"Usage: \"java MulticastServer MCastPort\" or \"java MulticastServer MCastAddr MCastPort\"");
					System.exit(1);
				}
