...
public class ServerSeq {
	public static final int PORT = 42069; // porta default per server
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				System.out.println("entrato while");
				Socket clientSocket = null;
				DataInputStream inSock = null;
				DataOutputStream outSock = null;
				System.out.println("create variabili");
				//
